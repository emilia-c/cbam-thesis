...
base_dir = r"master_thesis_2025\eu_data_extraction\EP\committee_meetings"
...
for pdf_path in pdf_files:
    try:
        ...
        # extract committee and date from the path (fixed structure)
        committee = path_parts[-4]  
        date = path_parts[-2]       

        print(f"Processing PDF: {file_name} (Committee: {committee}, Date: {date})")
...
# save to JSON file
output_json_path = os.path.join(base_dir, "committee_meetings_data.json")
